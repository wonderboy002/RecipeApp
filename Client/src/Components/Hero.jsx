    ...
    <>
      <section className="mt-20 flex w-full items-center gap-4">
          <div className="w-1/2 flex flex-col gap-4">
             ...
             <Link to="/AllRecipes" className="w-1/3 flex justify-center transtion-all duration-300 hover:bg-black hover:text-white hover:rounded-lg bg-white font-mono font-bold px-4 py-2">Browse Recipes</Link>
          </div>
